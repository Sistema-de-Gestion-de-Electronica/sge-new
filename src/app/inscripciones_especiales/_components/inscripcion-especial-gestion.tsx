...
import { inputGestionarInscripcionEspecialSchema } from "@/shared/filters/inscripciones-especiales-filter.schema";

type GestionarInscripcionEspecialFormData = z.infer<typeof inputGestionarInscripcionEspecialSchema>;
...
export const InscripcionEspecialGestion = ({
  ...
  const formHook = useForm<GestionarInscripcionEspecialFormData>({
    mode: "onChange",
    resolver: zodResolver(inputGestionarInscripcionEspecialSchema),
    defaultValues: {
      id: inscripcionEspecialId,
      justificacion: "",
    },
  ...
  const onSubmit = async (data: GestionarInscripcionEspecialFormData) => {
    ...
    //   },
    // });
    console.log("Aprobando con justificacion: ", data.justificacion);
    onAprobar();
  };
  ...
  const handleRechazo = async () => {
    ...
    //   },
    // );
    console.log("Rechazando con justificacion: ", values.justificacion);
    onRechazar();
  };
